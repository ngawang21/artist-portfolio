...
export async function getProfile(lang: Locale) {
  ...
  return {
    name: d.name,
    role: lang === 'fr' ? d.role_fr : d.role_en,
    tagline: lang === 'fr' ? d.tagline_fr : d.tagline_en,
    birthline: lang === 'fr' ? d.birthline_fr : d.birthline_en,
    statement: lang === 'fr' ? d.statement_fr : d.statement_en,
    bio: lang === 'fr' ? d.bio_fr : d.bio_en,
    ...
    location: lang === 'fr' ? d.location_fr : d.location_en,
    portrait: d.portrait,
